...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-216323.195883, 5367234.300125, 68110.565435, 5563672.199603], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-216323.195883, 5367234.300125, 68110.565435, 5563672.199603], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Enquête Hirondelles 2026 - Choix des mailles à prospecter pour les Landes</h2>';
        return titleElement;
    })(),
